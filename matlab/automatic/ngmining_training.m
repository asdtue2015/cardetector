...
%% cd to correct dir
ROOT_DIR = '/home/zhengyu/cardetector/';           % Put data folder path HERE !!!!!
...
fid = fopen('../../data/carDetector56x48_test.yml','w');                 % creat the new SVM classifier set output path HERE !!!!!
