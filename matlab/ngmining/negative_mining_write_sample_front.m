...
label_dir = '/home/hazem/Desktop/cardetectz/data/label_2';      % read positive labels
nlabels   = length(dir(fullfile(label_dir, '*.txt')));
%% image input
image_dir = '/home/hazem/Desktop/cardetectz/data/image_2';
nimages   = length(dir(fullfile(image_dir, '*.png')));
%% HOG block input
hog_dir = '/home/hazem/Desktop/cardetectz/data/hog_2';
nymls   = length(dir(fullfile(hog_dir, '*.yml')));

%% main loop

exbigmat  = importdata('../../data/negative_features.mat');
ncbigmat = [] ;
%%
total=min([nnclabels nimages])-1;
groupn=5;
npg=floor(total/groupn);

save('../../data/notcar_features.mat', 'ncbigmat');
bigmat= importdata('../../data/notcar_features.mat');
...
%             rectangle('Position',npos,'EdgeColor','red')
    ...
    %save('../../data/notcar_features.mat', 'bigmat');
 fclose('all') ;  
end
%%
exbigmat=[exbigmat;bigmat];
save('../../data/front_ov_100h.mat', 'exbigmat','-v7.3');
